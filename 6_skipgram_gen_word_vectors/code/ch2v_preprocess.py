...
fpath_list = ['utterances/task/task-correct.csv', 'utterances/task/task-error.csv']
# fpath_list = ['utterances/nontask/nontask-correct.csv', 'utterances/task/task-correct.csv']
output_fpath = 'ch2v_corpus_output'
